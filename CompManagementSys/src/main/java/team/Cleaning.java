...
public class Cleaning extends javax.swing.JFrame {
    ...
    public Cleaning() {
        ...
        compField.setBackground(new Color(0, 0, 0, 0));
    }
    
    String userName;
    public Cleaning (String username){
        initComponents();
        userName = username;
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("House Keeping Complaint");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(280, 10, 290, 40);

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("Write your complaint");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(90, 190, 200, 40);
        getContentPane().add(jLabel2);
        jLabel2.setBounds(280, 80, 0, 0);
        ...
        jScrollPane1.setBounds(90, 230, 690, 240);

        issue.setFont(new java.awt.Font("Helvetica Neue", 0, 14)); // NOI18N
        issue.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Room", "Corridor", "Common Room", "Others" }));
        getContentPane().add(issue);
        issue.setBounds(630, 110, 134, 25);

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("Issue Type");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(510, 110, 96, 24);
        ...
        jLabel6.setBounds(140, 110, 127, 24);
        ...
        jButton3.setBounds(600, 500, 110, 30);
        ...
        Submit.setBounds(150, 500, 110, 30);
        ...
        jButton1.setBounds(350, 500, 160, 30);

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\mdamm\\OneDrive\\Documents\\NetBeansProjects\\CompManagementSys\\src\\main\\java\\images\\4_1.png")); // NOI18N
    ...
    public boolean checComplaint (String userName) {
        ...
        try {
            ...
            String userquery = ("SELECT complaint FROM `cleaning_comp` WHERE username =?");
    ...
    public String getComplaintNo (){
        try {
            ...
            String query = ("SELECT cNo FROM cleaning_comp WHERE username =?");
            pstuser = con.prepareStatement(query);
            pstuser.setString(1, userName);
            rstuser = pstuser.executeQuery();
    ...
    public void emailSent (){
        ...
        try {
            ...
            message.setSubject("Cleaning Problems!");
        ...
        if(roomNo.equals("") || complaint.equals("")){
            ...
            try{
                ...
                if(!checComplaint(userName)){
                    ...
                    String compQuery = ("insert into cleaning_comp(`username`, `room_num`, `type`, `complaint`) values(?,?,?,?)");
                    ...
                    if(respond == JOptionPane.YES_OPTION){
                        ...
                        String compQuery = ("update cleaning_comp set room_num = ?, type = ?, complaint =? where username = ?");
                        pstuser = con.prepareStatement(compQuery);
