...
public class Security extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(100, 220, 690, 250);
        ...
        Submit.setBounds(170, 500, 110, 30);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\mdamm\\OneDrive\\Documents\\NetBeansProjects\\CompManagementSys\\src\\main\\java\\images\\3_1.png")); // NOI18N
    ...
    public boolean checComplaint (String userName) {
        ...
        try {
            ...
            String userquery = ("SELECT complaint FROM `security_comp` WHERE username =?");
    ...
    public String getComplaintNo (){
        try {
            ...
            String query = ("SELECT cNo FROM security_comp WHERE username =?");
            pstuser = con.prepareStatement(query);
            pstuser.setString(1, userName);
            rstuser = pstuser.executeQuery();
    ...
    public void emailSent (){
        ...
        try {
            ...
            message.setSubject("Security Issues!");
        ...
        if(roomNo.equals("") || complaint.equals("")){
            ...
            try{
                ...
                if(!checComplaint(userName)){
                    ...
                    String compQuery = ("insert into security_comp(`username`, `room_num`, `type`, `complaint`) values(?,?,?,?)");
                    ...
                    if(respond == JOptionPane.YES_OPTION){
                        ...
                        String compQuery = ("update security_comp set room_num = ?, type = ?, complaint =? where username = ?");
                        pstuser = con.prepareStatement(compQuery);
